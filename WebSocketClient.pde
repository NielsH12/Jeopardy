...
public class WebsocketClient {
	 ...
	 */
	public WebsocketClient(PApplet parent, String endpointURI) throws SocketException {
	...
	public WebsocketClient(PApplet parent, Object callbacks,
						   String endpointURI) throws SocketException {
        ...
        {
            throw new SocketException("Error while connecting to socket");
        }
	}
